module tb;
    ...
    reg clk;
    wire [31:0] PC_OUT, instr, RB_RD1, RB_RD2, EXT_SIGN_OUT, ALU_MUX_OUT, ALU_OUT, DM_MUX_OUT, DM_RD, BEQ_OFFSET, SUM_PC_OUT, SUM_BEQ_OUT, MUX_BEQ_OUT;
    wire [3:0] ALUOP;
    wire [4:0] WA_MUX_OUT;
    wire PCSRC, ZERO, REGWRITE, REGDST, EXTOP, ALUSRC, MEMWRITE, MEM2REG; // flags
    
    reg PC_RES;
    
    PC PC_inst(clk, PC_RES, MUX_BEQ_OUT, PC_OUT);
    ...
    MAIN_CONTROL MAIN_CONTROL_inst(instr[31:26], instr[5:0], PCSRC, ZERO, REGDST, REGWRITE, ALUSRC, MEMWRITE, MEM2REG, EXTOP, ALUOP);

module top(in, BT, clk, pl_bt, COUT, AOUT);
    ...
    wire [3:0] REG_OP_OUT, ERRF_OUT, MUX_OUT_7SEG;
    wire [11:0] REG_A_OUT, REG_B_OUT, ALU_OUT;
    wire clk_div, ERR, OF, UF, ZERO; // 8 - OF   E - ERR    2 - ZERO    U - UF   0 - OK
    
    REG #(12) REG_A(clk_div, in, BT[0] & pl_bt, REG_A_OUT);
    REG #(12) REG_B(clk_div, in, BT[1] & pl_bt, REG_B_OUT);
    REG #(4) REG_OP(clk_div, in[3:0], BT[2] & pl_bt, REG_OP_OUT);
    
    ALU #(12) ALU_inst(REG_A_OUT, REG_B_OUT, REG_OP_OUT, ALU_OUT, ERR, OF, UF, ZERO);
    
    MUX4_1 #(12) MUX_ALU(REG_A_OUT, REG_B_OUT, REG_OP_OUT, ALU_OUT, DEBUG_CMD, MUX_ALU_OUT); 
...
module REG #(parameter N = 8) (clk, in, pl, out);
